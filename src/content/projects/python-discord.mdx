...
description: Python Discord is a programming community with over 400,000 members from around the globe, I'm a Co-Founder and DevOps Lead for the community. I maintain the Kubernetes cluster which the Python Discord infrastructure resides on.
---
import Video from "../../components/Video.astro";

Python Discord is a programming community with over 400,000 members from around the globe.
